...
int contaPares(Arv *t) {
	if (t == NULL) return 0;
	if (t->info % 2 == 0) return 1 + contaPares(t->esq) + contaPares(t->dir);
	else return contaPares(t->esq) + contaPares(t->dir);
}
...
void menu(){
	...
	//-----------------------------------
	printf(" 9 - Mostra nos com 2 filhos\n");
	printf(" 10 - conta nos pares\n");
	//-----------------------------------
	printf(" 11 - Fim\n");
	printf(" ==> ");
}
	...
	do{
		...
		switch(op){
			...
			case 8://mostra nos sem filhos
				abb_semFilhos(a);
				break;
			case 9://mostra nos sem filhos
				comDoisFilhos(a);
				break;
			case 10://mostra nos sem filhos
				printf("\nNumero de nos pares: %d\n",contaPares(a));
				break;
		}
		printf("\n------------------------------\n");
		system("pause");
